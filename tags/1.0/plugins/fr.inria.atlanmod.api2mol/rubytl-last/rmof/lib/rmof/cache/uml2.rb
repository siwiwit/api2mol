...
module MetaProfile
  ...
  def eStructuralFeatures
    define_structural_features do
      ...
      define_reference 'ownedStereotype', Stereotype, :derived => true, :upperBound => -1
...
module MetaTransition
  ...
  def eStructuralFeatures
    define_structural_features do
      ...
      define_reference 'trigger', Trigger, :upperBound => -1
