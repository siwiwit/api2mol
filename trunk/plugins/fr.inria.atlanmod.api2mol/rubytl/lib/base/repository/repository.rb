  ...
  module Base
    ...
    class LoadedModel
      ...
      def serialize
        ...
        @proxy.serialize(@model_information.models.first)
      end
      
      def serialize_to_resource(resource)
        @proxy.serialize(resource)
      end
    ...
    class LoadedMultiModel
      ...
      def serialize
        raise "Invalid number of target models" if @model_information.models.size != 1
        @builder_result.serialize(@model_information.models.first)
      end
